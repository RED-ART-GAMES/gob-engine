...
namespace Gob {
	...
	public:
		...
		/// <summary>
		/// Allows to initialize the game & launch the game
		/// </summary>
		/// <returns>A boolean value to know if the internal state machine
		/// must relaunch the game (true) or not (false)</returns>
